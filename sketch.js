...
function changeSize5x5() {
    cols = 5;
    rows = 5;
    initaliseSearchExample(cols, rows);
}

function changeSize50x50() {
    cols = 50;
    rows = 50;
    initaliseSearchExample(cols, rows);
}

function changeSize100x100() {
    cols = 100;
    rows = 100;
    initaliseSearchExample(cols, rows);
}
...
function setup() {
    ...
    uiElements.push(new Button("Size: 5x5", 430, 300, 100, 30, changeSize5x5));
    uiElements.push(new Button("Size: 50x50", 430, 350, 100, 30, changeSize50x50));
    uiElements.push(new Button("Size: 100x100", 430, 400, 100, 30, changeSize100x100));
